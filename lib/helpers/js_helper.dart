// Code snippet from https://stackoverflow.com/questions/60209381/get-users-location-for-flutter-web
@JS('navigator.geolocation') // navigator.geolocation namespace
library js_helper; // library name can be whatever you want
